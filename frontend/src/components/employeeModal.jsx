...
const emptyForm = { name: "", email: "", jobRole: "", department: "", joinDate: "", phone: "", dbRole: "Employee" };
...
const EmployeeModal = ({ isOpen, onClose, onSave, employee, currentUserRole }) => {
  ...
  useEffect(() => {
    if (employee) {
      setForm({
        name: employee.name, email: employee.email, jobRole: employee.jobRole, department: employee.department, joinDate: employee.joinDate
