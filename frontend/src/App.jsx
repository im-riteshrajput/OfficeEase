...
function App() {
  ...
  const deleteEmployee = async (id, password) => {
    setGlobalLoading(true);
    try {
      await EmployeeData.deleteEmployee(id, password);
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route element={<DashboardLayout employees={employees} globalLoading={globalLoading} />}>
            ...
            <Route path="/employees" element={<Employees employees={employees} onDelete={deleteEmployee} onEdit={editEmployee} />} />
